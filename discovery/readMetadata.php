...
if(isRunViaCLI()){
	...
	if(is_array($metadataIDProviders)){ 
		...
		echo 'Dumping parsed Identity Providers to file '.$metadataIDPFile.".ignore\n";
		dumpFile($metadataIDPFile.'.ignore', $metadataIDProviders, 'metadataIDProviders');
	}
	...
	if(!file_exists($metadataSPFile) or filemtime($metadataFile) > filemtime($metadataSPFile)){
	...
	//AAF	if(is_array($metadataIDProviders)){
	//AAF		dumpFile($metadataIDPFile.'.ignore', $metadataIDProviders, 'metadataIDProviders');
	//AAF		$IDProviders = mergeInfo($IDProviders, $metadataIDProviders, $SAML2MetaOverLocalConf, $includeLocalConfEntries);
	//AAF	}
	...
	} elseif (file_exists($metadataSPFile)){
